        ...
        <main id="mainProfessor"> 
            ...
            <form method="post" action="professorEncerrarCorrecao.jsp?pmensagem=TesteSitema&professor=<%= vUsuProfessor%>&senha=<%= vSenhaProfessor%>&codigo=<%= vCodProfessor%>&codAluno=<%= vCodAluno%>&atividadeId=<%= atividadeId%>" >
                <div style="display: flex; flex-direction: column; justify-content: center; align-items: center"> 
                    ...
                    <br>
                    <textarea rows="3" cols="60" style="resize: none" name="comentario_professor" required="true">Digite Aqui Algum Comentário sobre a Resposta do Aluno</textarea>
                    <br>
                    <button type="submit" class="botaoFazerQuestao">Encerrar Correção</button>
                </div>
            </form>
            <div class="containerCenter">                
                <div class="containerProfessorConteudo">  
                    ...
                    <%for (Questao questao : listaQuestao) {
                            String respostaCadastrada = questao.getResposta_cadastrada();
                            String valorAlternativa = questao.getAlternativa_correta();
                            if (respostaCadastrada == null && "-".equals(valorAlternativa)) {
                    %>
                    ...
                    <% } else if (respostaCadastrada == null && !"-".equals(valorAlternativa)) {
                    ...
                    <% } else if ("-".equals(valorAlternativa)) {
