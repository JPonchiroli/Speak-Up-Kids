    ...
    <body>
        <%
            ...
            ques.setCod_questao(codQuestao);
             ...
             if (ques.cadastrarQuestaoAluno()){
                Questao ques1 = new Questao();
                ques1.setCod_aluno(codAluno);
                ques1.setCod_professor(codProfessor);
                ques.setCod_questao(codQuestao);
                ques1.setResposta_cadastrada(resposta_cadastrada);
                ques.setCod_atividade(codAtividade);
                
                ques1.alterarQuestaoAluno();
