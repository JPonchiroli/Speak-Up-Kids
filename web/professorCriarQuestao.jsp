...
<html>
    ...
    <body>
        <%  String vUsuProfessor = request.getParameter("professor");
            ...
            if (cadastroQuestao) {
                Questao ques1 = new Questao();
                ques1.setCod_atividade(codAtividade);
                int codQuestao = ques1.consultarCodQuestao(codAtividade, numero_questao);
                ques1.setCod_questao(codQuestao);
                
                boolean cadastroQuestaoAluno = ques1.cadastrarQuestaoAluno();
